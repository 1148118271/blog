...
var map = std.hash_map.StringHashMap([]const u8).init(std.heap.page_allocator);
...
fn init() void {
    ...
    put(".cat", "application/s-pki.seccat");
    ...
    put(".mp4", "video/mp4");
    put(".mpa", "video/x-mpg");
    put(".mpd", "application/-project");
    put(".mpe", "video/x-mpeg");
    put(".mpeg", "video/mpg");
    put(".mpg", "video/mpg");
    put(".mpga", "audio/rn-mpeg");
    put(".mpp", "application/-project");
    put(".mps", "video/x-mpeg");
    put(".mpt", "application/-project");
    put(".mpv", "video/mpg");
    put(".mpv2", "video/mpeg");
    put(".mpw", "application/s-project");
    put(".mpx", "application/-project");
    put(".mtx", "text/xml");
    ...
    put(".pko", "application-pki.pko");
    put(".pl", "application/x-perl");
    put(".plg", "text/html");
    put(".pls", "audio/scpls");
    put(".plt", "application/x-plt");
    put(".png", "image/png");
    put(".pot", "applications-powerpoint");
    put(".ppa", "application/vs-powerpoint");
    put(".ppm", "application/x-ppm");
    put(".pps", "application-powerpoint");
    put(".ppt", "applications-powerpoint");
    ...
    put(".pwz", "application/powerpoint");
    ...
    put(".sst", "application-pki.certstore");
    put(".stl", "application/-pki.stl");
    put(".stm", "text/html");
...
pub fn get(path: []const u8) ?[]const u8 {
    ...
    var index = std.mem.lastIndexOf(u8, path, ".");
    if (index == null) {
        return null;
    }
    return map.get(path[index.?..path.len]);
}
