...
pub const Datetime = struct {
    ...
    pub fn nowGMT8() Datetime {
        return Datetime.fromTimestampGMT8(time.milliTimestamp());
    }
    ...
    // Beijing
    pub fn fromTimestampGMT8(timestamp: i64) Datetime {
        var d = fromTimestamp(timestamp + (time.ms_per_hour * 8));
        d.zone = &timezones.Etc.GMTm8;
        return d;
    }
